...
def main():
    ...
    print(f'A* time is: {time() - t0:.2f} seconds')
    print('Count of nodes expanded in A* is:', count_nodes_expanded)
    ...
    while frontier and not goal_found:
        ...
        for neighbor in neighbors:
            ...
            closed[neighbor_key] = 1

    print(f'BFS time is: {time() - t0:.2f} seconds')
    print('Count of nodes expanded in BFS is:', count_nodes_expanded)
